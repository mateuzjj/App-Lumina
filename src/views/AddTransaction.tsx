...
export const AddTransaction: React.FC<AddTransactionProps> = ({ initialDate, onSave, onCancel }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] bg-[#030712] flex flex-col animate-slide-up overflow-y-auto no-scrollbar touch-scroll select-none">
      
      {/* Spacer to push content down if needed, or act as container */}
      <div className="min-h-[100dvh] flex flex-col w-full max-w-md mx-auto relative bg-[#030712]">
      
          {/* Header */}
          <div className="flex justify-between items-center px-6 pt-safe pb-2 relative z-20 shrink-0 mt-4">
          ...
          {/* Middle Content (Value Display) */}
          <div className="flex-1 flex flex-col items-center justify-center min-h-[250px] relative z-10 shrink-0">
          ...
          {/* Bottom Sheet (Categories + Keypad) */}
